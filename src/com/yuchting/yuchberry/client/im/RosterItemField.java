...
public class RosterItemField extends Field{
	...
	protected void drawFocus(Graphics _g,boolean _on){
		...
		// draw roster state
		//
		drawRosterState(_g,2,18,m_currRoster.m_roster.getPresence());  //RRR:(_g,1,6,m_currRoster.m_roster.getPresence());
		...
		if(m_currRoster.m_hasNewMessage){
			recvMain.sm_weiboUIImage.drawImage(_g,SliderHeader.GetBBerSignBitmap(),4,3);//RRR:新消息(_g,SliderHeader.GetBBerSignBitmap(),1,20);
		}

...
public class MainChatScreen extends MainScreen implements ChatField.IChatFieldOpen{
	...
	final class ChatScreenHeader extends Field{
		...
		public int getPreferredHeight() {
			return m_mainApp.m_imChatScreenShowHeadImg?38:30;//RRR:聊天对话框选择头像显示时的 Header高度 54:30
		}
		...
		protected void paint(Graphics _g){
			...
			try{
				...
				if(m_mainApp.m_imChatScreenShowHeadImg){
					...
					_g.drawText(t_status,t_x + 6,RosterItemField.fsm_addressFontHeight + 4); //RRR:微调用户名字体_g.drawText(t_status,t_start_x + 4,MainIMScreen.fsm_boldFont.getHeight() - 4);

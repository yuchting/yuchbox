...
public class audioViewScreen extends fileViewScreen{
	...
	public audioViewScreen(String _filename,recvMain _mainApp)throws Exception{
		...
		ByteArrayInputStreamDataSource in = new ByteArrayInputStreamDataSource(new ByteArrayInputStream(m_fileContain),t_type);
		
		m_player = javax.microedition.media.Manager.createPlayer(in);

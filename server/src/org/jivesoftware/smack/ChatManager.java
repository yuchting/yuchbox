...
public class ChatManager {
    ...
    // YuchTing modified
    //
    // the Connection.disconnect will clear the all PacketLister via packetRead.cleanup
    // so we must init again in Connection.connect (XMPPConnection.initConnection)
    //
    // if recreate XMPPConnection it will start massess Thread to reconnect
    //
    public void init(){
